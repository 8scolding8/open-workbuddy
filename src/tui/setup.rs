...
mod tests {
    ...
    fn stale_port_error_has_safe_readable_os_specific_recovery() {
        let message = port_recovery_guidance(
            40589,
            "The configured port is running a different WorkBuddy proxy build",
        );
