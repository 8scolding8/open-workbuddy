...
Verify model aliases (`gpt-4o`, `gpt-4`, `gpt-5.6`, `workbuddy-default`, absent model, canonical model, unknown model policy) normalize exactly as intended.
